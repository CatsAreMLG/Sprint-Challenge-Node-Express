...
- [ ] Mention two parts of Express that you learned about this week.
      how to properly set up a server and routes

- [ ] Describe Middleware?
      middleware is functions that take data, check or edit it, and pass it along through the program

- [ ] Describe a Resource?
      A resource is a thing that can have CRUD operations performed on it
